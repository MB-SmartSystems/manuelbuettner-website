  ...
  theme: {
    extend: {
      colors: {
        base: '#1E2E34',
        surface: '#2F3E46',
        'surface-raised': '#354F52',
        'surface-overlay': '#3A5A52',
        'surface-bright': '#52796F',
        accent: '#84A98C',
        'accent-dim': '#52796F',
        'accent-glow': 'rgba(132, 169, 140, 0.15)',
        'accent-subtle': 'rgba(132, 169, 140, 0.08)',
        'on-dark': '#CAD2C5',
        'on-dark-muted': '#84A98C',
        'on-dark-subtle': '#52796F',
        'glass-bg': 'rgba(202, 210, 197, 0.04)',
        'glass-border': 'rgba(202, 210, 197, 0.08)',
